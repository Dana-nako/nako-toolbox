const CACHE_NAME = 'nako-toolbox-v2-public-safe';
const ASSETS = ['./','./index.html','./name-replacer.html','./word-replacer.html','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
