const CACHE_NAME = 'nako-toolbox-v3-cat-icon';
const ASSETS = ['./','./index.html','./name-replacer.html','./word-replacer.html','./manifest.json','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
